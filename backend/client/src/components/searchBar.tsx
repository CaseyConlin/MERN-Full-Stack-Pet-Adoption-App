...
export const SearchBar = ({
  ...
  return (
    <Form id="search-form" role="search">
      <fieldset className="inline-flex rounded-md shadow-sm" role="group">
        <div className="inline-flex items-center px-2 py-2 text-2xl font-medium text-gray-900 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
          Show Me:
        </div>
        <button
          id="cat"
        ...
        <button
          ...
          name="species"
          type="button"
          className="inline-flex items-center px-4 py-0 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white"
        >
          <svg
            aria-hidden="true"
      ...
      <fieldset className="flex my-3 rounded-md shadow-sm" role="group">
        <div className="inline-flex items-center px-2 py-2 text-2xl font-medium text-gray-900 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
          Sort By:
        </div>
        <div
        ...
        >
          <button
            ...
            name="sort"
            value="age"
            className="px-4 py-2 w-34 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white"
          >
            Age
          </button>
          <button
            ...
            name="sort"
            value="fee"
            className="px-4 py-0 w-34 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white"
          >
            Fee
          </button>
          <button
